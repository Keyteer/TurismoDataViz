textos = {
    ...
    # Modal ajustes
        ...
        "cerrar": "Cerrar",
    # Para los indicadores del DataFrame 1
        "indicadores_df1": {
    ...
    # PLOT 7
        "titulo_plot7": "Comparación de {indicador_x} y {indicador_y} en {pais}",
    ...
    # PLOT 7
        "titulo_plot7": "Comparison of {indicador_x} and {indicador_y} in {pais}",
